...
PImage saying4, saying5, saying6;
...
void setup() {
 ...
 GermanySmall = loadImage("germanySmall.png");
 ItalySmall = loadImage("italySmall.png");
 SpainSmall = loadImage("spainSmall.png");
 USASmall = loadImage("usaSmall.png");
 ChinaSmall = loadImage("chinaSmall.png");
 UKSmall = loadImage("ukSmall.png");
 RussiaSmall = loadImage("russiaSmall.png");
 CanadaSmall = loadImage("canadaSmall.png");
 mainMenu = loadImage("MainMenu.png");
 selCount = loadImage("selCount.png");
 switzerland = loadImage("switzerland.png");
 powBlock = loadImage("powBlock.png");
 ChinaBig = loadImage("chinaBig.png");
 Australia = loadImage("australia.png");
 wallOfSnow = loadImage("wallOfSnow.png");
 ironCurtain = loadImage("ironCurtain.png");
 wallOfSnowCPU = loadImage("wallOfSnowCPU.png");
 pauseMenu = loadImage("menu.png");
 pauseMenu2 = loadImage("menu2.png");
 credits = loadImage("credits.png");
 bracket = loadImage("bracket.png");
 instructions = loadImage("instructions.png");
 achievements = loadImage("achievements.png");
 CanadaIcon = loadImage("canadaIcon.png");
 ChinaIcon = loadImage("chinaIcon.png");
 GermanyIcon = loadImage("germanyIcon.png");
 ItalyIcon = loadImage("italyIcon.png");
 RussiaIcon = loadImage("russiaIcon.png");
 SpainIcon = loadImage("spainIcon.png");
 UKIcon = loadImage("ukIcon.png");
 USAIcon = loadImage("usaIcon.png");
 cdCanada = loadImage("cdCanada.png");
 cdChina = loadImage("cdChina.png");
 cdGermany = loadImage("cdGermany.png");
 cdItaly = loadImage("cdItaly.png");
 cdSpain = loadImage("cdSpain.png");
 cdRussia = loadImage("cdRussia.png");
 cdUK = loadImage("cdUK.png");
 cdUSA = loadImage("cdUSA.png");
 shop = loadImage("shop.png");
 stats = loadImage("stats.png");
 saying1 = loadImage("saying1.png");
 saying2 = loadImage("saying2.png");
 bracket2 = loadImage("bracket2.png");
 World = loadImage("world.png");
 saying3 = loadImage("saying3.png");
 saying4 = loadImage("saying4.png");
 saying5 = loadImage("saying5.png");
 saying6 = loadImage("saying6.png");
 CanadaWin = loadImage("canadaWin.png");
 ChinaWin = loadImage("ChinaWin.png");
 GermanyWin = loadImage("GermanyWin.png");
 ItalyWin = loadImage("ItalyWin.png");
 RussiaWin = loadImage("RussiaWin.png");
 SpainWin = loadImage("SpainWin.png");
 UKWin = loadImage("UKWin.png");
 USAWin = loadImage("USAWin.png");
 arrowKeys = loadImage("arrowKeys.png");
 defaulted = loadImage("defaulted.png");
 unknown = loadImage("unknown.png");
 BBBnohelpneeded = loadImage("BBBnohelpneeded.png");
 field2 = loadImage("field2.png");
 field3 = loadImage("field3.png");
 field4 = loadImage("field4.png");
 BBBmakeitrain = loadImage("BBBmakeitrain.png");
 BBBsmartmove = loadImage("BBBsmartmove.png");
 BBBgoalhero = loadImage("BBBgoalhero.png");
 BBBfathertime = loadImage("BBBfathertime.png");
 BBBblowout = loadImage("BBBblowout.png");
 BBBoffensivethreat = loadImage("BBBoffensivethreat.png");
 BBBreadcredits = loadImage("BBBreadcredits.png");
 achievements2 = loadImage("achievements2.png");
 BBBworldchamp = loadImage("BBBworldchamp.png");
 BBBdiversityday = loadImage("BBBdiversityday.png");
 BBBflawless = loadImage("BBBflawless.png");
 BBBwinthreeworlds = loadImage("BBBwinthreeworlds.png");
 BBBclickclickboom = loadImage("BBBclickclickboom.png");
 BBBdvsg = loadImage("BBBdvsg.png");
 BBBsmallbutmighty = loadImage("BBBsmallbutmighty.png");
 BBBonebeatstwo = loadImage("BBBonebeatstwo.png");
 ggmakeitrain = loadImage("ggmakeitrain.png");
 ggsmartmove = loadImage("ggsmartmove.png");
 gggoalmaster = loadImage("gggoalmaster.png");
 ggfathertime = loadImage("ggfathertime.png");
 ggonesided = loadImage("ggonesided.png");
 ggoffensivethreat = loadImage("ggoffensivethreat.png");
 ggrealmvp = loadImage("ggrealmvp.png");
 ggworldchampion = loadImage("ggworldchampion.png");
 ggdiversityday = loadImage("ggdiversityday.png");
 ggflawless = loadImage("ggflawless.png");
 ggticktickboom = loadImage("ggticktickboom.png");
 ggonebeatstwo = loadImage("ggonebeatstwo.png");
 ggdvsg = loadImage("ggdvsg.png");
 ggsmallbutmighty = loadImage("ggsmallbutmighty.png");
 ggnohelpneeded = loadImage("ggnohelpneeded.png");
 ggtrifecta = loadImage("ggtrifecta.png");
 spacebar = loadImage("spacebar.png");
 ggtrifecta2 = loadImage("ggtrifecta2.png");
 ggrealmvp2 = loadImage("ggrealmvp2.png");
 saying7 = loadImage("saying7.png");
 saying8 = loadImage("saying8.png");
 introScreen = loadImage("introScreen.jpg");
 bullet = loadImage("bullet.png");
 advice1 = loadImage("advice1.png");
 advice2 = loadImage("advice2.png");
 advice3 = loadImage("advice3.png");
 advice4 = loadImage("advice4.png");
 advice5 = loadImage("advice5.png");
 selcount2 = loadImage("selCount2.png");
 advice6 = loadImage("advice6.png");
 advice7 = loadImage("advice7.png");
 advice8 = loadImage("advice8.png");
 advice9 = loadImage("advice9.png");
 advice10 = loadImage("advice10.png");
 advice11 = loadImage("advice11.png");
 advice12 = loadImage("advice12.png");
 advice13 = loadImage("advice13.png");
 advice14 = loadImage("advice14.png");
 advice15 = loadImage("advice15.png");
 advice16 = loadImage("advice16.png");
 selcount3 = loadImage("selCount3.png");
 surprise = loadImage("surprise.png");
 Brazil = loadImage("Brazil.png");
 BrazilSmall = loadImage("BrazilSmall.png");
 France = loadImage("France.png");
 FranceSmall = loadImage("FranceSmall.png");
 Portugal = loadImage("portugal.png");
 PortugalSmall = loadImage("PortugalSmall.png");
 Argentina = loadImage("Argentina.png");
 ArgentinaSmall = loadImage("ArgentinaSmall.png");
 cdArgentina = loadImage("cdArgentina.png");
 cdBrazil = loadImage("cdBrazil.png");
 cdFrance = loadImage("cdFrance.png");
 cdPortugal = loadImage("cdPortugal.png");
 ArgentinaIcon = loadImage("ArgentinaIcon.png");
 BrazilIcon = loadImage("BrazilIcon.png");
 FranceIcon = loadImage("FranceIcon.png");
 PortugalIcon = loadImage("PortugalIcon.png");
 ArgentinaWin = loadImage("ArgentinaWin.png");
 BrazilWin = loadImage("BrazilWin.png");
 FranceWin = loadImage("FranceWin.png");
 PortugalWin = loadImage("PortugalWin.png");
...
void draw() {
 ...
 if (screenNum == 14) {
  ...
  } else if (mouseX >= 467 & mouseY >= 319 & mouseX <= 570 & mouseY <= 422 & winthreeworlds == false) {
   image(ggtrifecta, 82, 11);
  } else if (mouseX >= 467 & mouseY >= 319 & mouseX <= 570 & mouseY <= 422 & winthreeworlds == true) {
 ...
 if (tourney == true & tourneyBegin == false) {
  ...
  //Italy
  if (mouseX >= 487 & mouseX <= 650 & mouseY >= 135 & mouseY <= 286 & screenNum < 90) {
   rect(487, 135, 161, 151);
  }
  //USA
  ...
  //China
  else if (mouseX >= 0 & mouseX <= 149 & mouseY >= 135 & mouseY <= 286 & screenNum < 90) {
   rect(0, 135, 151, 151);
  }
  //Spain
 ...
 if (quickGame == true) {
  ...
  //Italy
  if (mouseX >= 487 & mouseX <= 650 & mouseY >= 135 & mouseY <= 286) {
   rect(487, 135, 161, 151);
  }
  //USA
  else if (mouseX >= 316 & mouseX <= 487 & mouseY >= 135 & mouseY <= 286) {
   rect(316, 135, 171, 151);
  }
  //Germany
  else if (mouseX >= 149 & mouseX <= 316 & mouseY >= 135 & mouseY <= 286) {
   rect(149, 135, 166, 151);
  }
  //China
  else if (mouseX >= 0 & mouseX <= 149 & mouseY >= 135 & mouseY <= 286) {
   rect(0, 135, 151, 151);
  }
  //Spain
...
void mouseClicked() {
 ...
 if (mouseX >= 46 & mouseY >= 106 & mouseX <= 149 & mouseY <= 209 & screenNum == 14 & diversityday == true & doubleClick == false) {
  ...
  screenNum = 29;
  doubleClick = true;
 } else if (mouseX >= 467 & mouseY >= 319 & mouseX <= 570 & mouseY <= 422 & screenNum == 14 & winthreeworlds == true & doubleClick == false) {
  screenNum = 30;
  doubleClick = true;
 }
