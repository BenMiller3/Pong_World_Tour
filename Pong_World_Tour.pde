...
if(secretSel==0){image(selCount,0,0);}
else if(secretSel==1){image(selcount2,0,0);}
else if(secretSel==2){image(selcount3,0,0);}
...
else if(SpainPower==true & pause==-1){}
